...
enum EntityType { PLATFORM, PLAYER, ENEMY, LIVES, MENU };
...
private:
    ...
    float     m_speed,
              m_jumping_power = 4.5f,
              m_direction;
    
    float m_ai_direction = 1.0f;
...
public:
    ...
    int lives = 3;
    bool killed = (lives == 0) ? true : false;
    ...
    void const check_enemy_collision_y(Entity* collidable_entities, int collidable_entity_count);
